...
if (pageStr.includes(stringToReplace)) {
  ...
  console.log("Successfully matched and replaced block 4.");
} else {
...
if (pageStr.includes(finalAccordionEnd)) {
  // It's the same so no change needed, just confirming it matches.
}

// Finally convert \n back to os-specific if needed, but it works fine with just \n in modern editors.
